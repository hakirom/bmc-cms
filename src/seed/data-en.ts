...
export const homeEn = {
  ...
  ctaPrimario: { etiqueta: 'Explore our markets', url: '/portal' },
  ctaSecundario: { etiqueta: 'Platform access', url: '/acceso' },
  ...
  ctaTablero: { etiqueta: 'More market information', url: '/portal' },
  ...
  panelCifras: {
    titulo: 'BMC indicators',
    descripcion: 'Institutional summary of the latest close',
    fuente: 'Power BI',
    actualizado: 'Updated today, 06:00',
    enlaceInforme: { etiqueta: 'Open full report', url: '/portal' },
  },
  cifras: [
    { valor: '46', etiqueta: 'years of experience', tendencia: 'stable', progreso: 92 },
    { valor: '+3,500', etiqueta: 'entities and companies served', tendencia: '+8.4% yearly', progreso: 74 },
    { valor: '+40', etiqueta: 'brokerage firms', tendencia: '+2 this year', progreso: 58 },
    { valor: '24/7', etiqueta: 'registration platforms available', tendencia: '99.9% uptime', progreso: 99 },
  ],
  mensajesValor: [
